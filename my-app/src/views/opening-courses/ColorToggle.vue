      ...
      >
        <span class="color-switch__outline">
          <span class="color-switch__thumb color-switch__thumb--white" aria-hidden="true">
            <img :src="kingIconSrc" alt="" class="color-switch__king-icon" aria-hidden="true" />
          </span>
        </span>
      </button>
      <button
...
/* Outline wrapper: larger than thumb so outline has distance (like course card cover-wrap) */
