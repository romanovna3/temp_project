...
// V2.2-only: fixed version flags (production source).
const route = useRoute()
const isVideoV2_4 = ref(false)
const isVideoV5 = ref(false)
const isVideoV6 = ref(false)
const isVideoV7 = ref(false)
const isVideoV8 = ref(false)
const isVideoV7OrV8 = ref(false)
const isVideoV6OrV7 = ref(false)
const isVideoV2_4OrV5 = ref(false)
const isVideoV5OrV6 = ref(false)
const isVideoV4OrV5OrV6 = ref(false)
const isVideoV2 = ref(false)
const isVideoV2_2 = ref(true)
const isVideoV2_3OrV24 = ref(false)
...
// V2.2: isVideoV2, isVideoV2_2 defined at top
...
// V2.2: isVideoV2_3OrV24 defined at top
