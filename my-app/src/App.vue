...
// Video section: show in panel when Video button clicked; resizable by dragging handle
    ...
    <div class="layout">
      ...
      <div class="review-panel">
        ...
        <div ref="coursesContentRef" class="panel-content courses-content">
          ...
          <!-- VideoSection – visible when Video button clicked; under course card -->
          <section ref="videoSectionRef" v-show="showVideoSection" class="video-section" data-name="VideoSection">
            <div
          ...
          <!-- Rest of content – hidden when video section is on -->
          ...
          <!-- Sections list – Chapter V2 items + Move Item List when expanded -->
          <div class="sections-list">
            <div v-for="section in courseSections" :key="section.id" class="section-item">
              <button
                type="button"
                class="chapter-v2"
                :class="{ 'chapter-v2--sticky-under-video': showVideoSection && isSectionExpanded(section.id) }"
                :style="showVideoSection && isSectionExpanded(section.id) ? { '--sticky-under-video-top': videoSectionHeightPx + 'px' } : undefined"
                ...
                >
                  ...
                  <div class="move-item-content">
                    <div class="move-item-inner">
                      ...
                      <!-- Completed Default: static level chip (e.g. L1 aqua) -->
        ...
        <section class="footer-section footer-section-actions">
          <div v-if="showLessonActions" class="footer-buttons-container">
...
/* VideoSection – under course card; bg opaque */
.video-section {
  display: flex;
  flex-direction: column;
  align-items: center;
...
/* Footer: 2 sections – top = CTA buttons, bottom = toolbar */
.panel-footer {
  background: var(--color-bg-tertiary);
  padding: 0;
  display: flex;
